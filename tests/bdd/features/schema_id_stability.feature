...
Feature: Schema ID Stability and Content Validation
  ...
  Scenario: Same Avro schema in two subjects gets same ID verified via GET
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                            |
      | method               | POST                                         |
      | path                 | /subjects/idstab-avro-b/versions             |
      | status_code          | 200                                          |
      | reason               |                                              |
      | error                |                                              |
      | request_body         |                                              |
  ...
  Scenario: Different schema content gets different IDs
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                            |
      | method               | POST                                         |
      | path                 | /subjects/idstab-diff-b/versions             |
      | status_code          | 200                                          |
      | reason               |                                              |
      | error                |                                              |
      | request_body         |                                              |
  ...
  Scenario: Auto-assigned IDs after import are strictly greater than imported IDs
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                            |
      | method               | POST                                         |
      | path                 | /subjects/idstab-seq-new/versions            |
      | status_code          | 200                                          |
      | reason               |                                              |
      | error                |                                              |
      | request_body         |                                              |
  ...
  Scenario: References survive permanent delete of non-referenced registration
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                            |
      | method               | DELETE                                       |
      | path                 | /subjects/idstab-ref-base-b                  |
      | status_code          | 200                                          |
      | reason               |                                              |
      | error                |                                              |
      | request_body         |                                              |
  ...
  Scenario: References survive permanent delete of canonical first-registered subject
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                            |
      | method               | DELETE                                       |
      | path                 | /subjects/idstab-ref-canon-a                 |
      | status_code          | 200                                          |
      | reason               |                                              |
      | error                |                                              |
      | request_body         |                                              |
