...
Feature: MCP Validation, Export, and Statistics Tools
  ...
  Scenario: Export all versions for a subject
    ...
    And the audit log should contain an event:
      ...
      | role                 |                        |
      | target_type          | subject                |
      | target_id            | export-subj-val-test   |
      | schema_id            |                        |
      | version              |                        |
      | schema_type          |                        |
      | before_hash          |                        |
