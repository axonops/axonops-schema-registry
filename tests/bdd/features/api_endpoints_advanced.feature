...
Feature: API Endpoint Behaviors Advanced
  ...
  Scenario: Schema type defaults to AVRO when not specified
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                        |
      | method               | POST                                     |
      | path                 | /subjects/default-type-test/versions     |
      | status_code          | 200                                      |
      | reason               |                                          |
      | error                |                                          |
      | request_body         |                                          |
  ...
  Scenario: References field omitted from response when schema has no references
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                        |
      | method               | POST                                     |
      | path                 | /subjects/no-refs-test/versions          |
      | status_code          | 200                                      |
      | reason               |                                          |
      | error                |                                          |
      | request_body         |                                          |
  ...
  Scenario: References field present when schema has references
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                        |
      | method               | POST                                     |
      | path                 | /subjects/ref-parent/versions            |
      | status_code          | 200                                      |
      | reason               |                                          |
      | error                |                                          |
      | request_body         |                                          |
  ...
  Scenario: Raw schema by ID returns schema text not JSON wrapper
    ...
    And the audit log should contain an event:
      ...
      | user_agent           | *                                        |
      | method               | POST                                     |
      | path                 | /subjects/raw-by-id-test/versions        |
      | status_code          | 200                                      |
      | reason               |                                          |
      | error                |                                          |
      | request_body         |                                          |
